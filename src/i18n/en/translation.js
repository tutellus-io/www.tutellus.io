export const translation = {
    ...
    benefits_title: 'Benefits for Users',
    benefits_description: 'The new Tutellus will improve exponentially the experience for Students and Teachers',
    benefit_earn_studying: 'Earn money while studying',
    benefit_learn_more: 'Learn more and better',
    benefit_relevance: 'Get rewards with Relevance',
    benefit_use_crypto: 'Pay in cryptocurrency',
    benefit_wordwide_payments: 'Access from complex fiat markets: Venezuela, Cuba, etc.',
    benefit_instant_payments: 'Get payments instantly',
    benefit_earn_via_best_students: 'Earn money with best Students',
    benefit_earn_via_relevance: 'Earn money with Relevance',
    benefit_earn_via_subscriptions: 'Earn money with Subscriptions',
    benefit_exclusive_services: 'Acecss to exclusive Promotional and Marketing Services',
    ...
    roadmap_description: "A solid infrastructure always in 'reinventing mode' and focus on Users through a complete serives decentralized model",
    mvp: "MVP",
